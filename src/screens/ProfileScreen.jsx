  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#0b0f14' }}>
      ...
      <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
        {/* Profile Banner */}
        <ProfileBanner bannerId={user.equippedBanner} />
        ...
        <View style={{ paddingHorizontal: 16, paddingVertical: 16, alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#374151', marginTop: -40 }}>
          <View style={{ marginBottom: 12 }}>
            <ProfilePicture avatar={user.avatar} size={80} streakCount={currentStreak} />
          </View>
          ...
          <View style={{ width: '100%', marginTop: 16 }}>
            ...
            <View style={{ marginBottom: 20, paddingHorizontal: 16 }}>
              <Pressable
                onPress={() => navigation.navigate('BannerCollection', { userId: user.id })}
                style={({ pressed }) => ({
              ...
              >
                <Text style={{ color: 'white', fontSize: 14, fontWeight: '600' }}>Banner Collection</Text>
              </Pressable>
            </View>
